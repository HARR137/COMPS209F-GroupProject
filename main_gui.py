...
class  MainGUI:
    def __init__(self):
        ...
        self.lm1Img = createImg(self,"resources/img/jakeWhat.gif", self.lmCrood1["x"], self.lmCrood1["y"])

        #Learning Moduel 2
        self.lm2MsgBox = createMsgBox(
            self,
        ...
        self.lm2Img = createImg(self,"resources/img/mindBlow.gif", self.lmCrood2["x"], self.lmCrood2["y"])

        #Learning Moduel 3
        self.lm3MsgBox = createMsgBox(
            self,
        ...
        self.lm3Img =createImg(self,"resources/img/no.gif", self.lmCrood3["x"], self.lmCrood3["y"])

        #Learning Moduel 4
        self.lm4MsgBox = createMsgBox(
            self,
        ...
        self.lm4Img =createImg(self,"resources/img/terrytictictic.gif", self.lmCrood4["x"], self.lmCrood4["y"])
